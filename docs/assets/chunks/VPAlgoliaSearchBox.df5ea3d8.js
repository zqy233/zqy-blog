import { f as defineComponent, u as useData, g as useRoute, h as useRouter, i as onMounted, o as openBlock, c as createElementBlock } from "../app.dd2b519a.js";
  ...
  if (this.__b) {
    if (this.__v.__k) {
      ...
      this.__v.__k[0] = function e3(t3, n3, r3) {
        ...
        }), t3.__c.__H = null), null != (t3 = fe({}, t3)).__c && (t3.__c.__P === r3 && (t3.__c.__P = n3), t3.__c = null), t3.__k = t3.__k && t3.__k.map(function(t4) {
          return e3(t4, n3, r3);
        })), t3;
...
var Pe = "undefined" != typeof Symbol && Symbol.for && Symbol.for("react.element") || 60103, Ie = /^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|fill|flood|font|glyph(?!R)|horiz|marker(?!H|W|U)|overline|paint|stop|strikethrough|stroke|text(?!L)|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/, ke = function(e2) {
...
s.vnode = function(e2) {
  ...
  if ("string" == typeof t2) {
    for (var o2 in r2 = {}, n2) {
      var c2 = n2[o2];
      "value" === o2 && "defaultValue" in n2 && null == c2 || ("defaultValue" === o2 && "value" in n2 && null == n2.value ? o2 = "value" : "download" === o2 && true === c2 ? c2 = "" : /ondoubleclick/i.test(o2) ? o2 = "ondblclick" : /^onchange(textarea|input)/i.test(o2 + t2) && !ke(n2.type) ? o2 = "oninput" : /^on(Ani|Tra|Tou|BeforeInp)/.test(o2) ? o2 = o2.toLowerCase() : Ie.test(o2) ? o2 = o2.replace(/[A-Z0-9]/, "-$&").toLowerCase() : null === c2 && (c2 = void 0), r2[o2] = c2);
    }
  ...
  t2 && n2.class != n2.className && (Te.enumerable = "className" in n2, null != n2.className && (r2.class = n2.className), Object.defineProperty(r2, "className", Te)), e2.$$typeof = Pe, Le && Le(e2);
};
var qe = s.__r;
s.__r = function(e2) {
  qe && qe(e2), Re = e2.__c;
...
var Ke = Ue.forwardRef(function(e2, t2) {
  var n2 = e2.translations, r2 = void 0 === n2 ? {} : n2, o2 = We(e2, Ve), c2 = r2.buttonText, i2 = void 0 === c2 ? "Search" : c2, a2 = r2.buttonAriaLabel, u2 = void 0 === a2 ? "Search" : a2, l2 = oe(function() {
    return "undefined" != typeof navigator ? /(Mac|iPhone|iPod|iPad)/i.test(navigator.platform) ? "\u2318" : "Ctrl" : null;
  }, []);
  return Ue.createElement("button", ze({ type: "button", className: "DocSearch DocSearch-Button", "aria-label": u2 }, o2, { ref: t2 }), Ue.createElement("span", { className: "DocSearch-Button-Container" }, Ue.createElement(Be, null), Ue.createElement("span", { className: "DocSearch-Button-Placeholder" }, i2)), Ue.createElement("span", { className: "DocSearch-Button-Keys" }, null !== l2 && Ue.createElement(Ue.Fragment, null, Ue.createElement("span", { className: "DocSearch-Button-Key" }, "Ctrl" === l2 ? Ue.createElement(Fe, null) : l2), Ue.createElement("span", { className: "DocSearch-Button-Key" }, "K"))));
});
function Ge(e2) {
...
function pt(e2, t2) {
  ...
  return Promise.resolve(e2(t2)).then(function(e3) {
    return Promise.all(e3.filter(function(e4) {
      ...
      if (et("string" == typeof e4.sourceId), n2.includes(e4.sourceId))
...
function Mt(e2, t2) {
  return n2 = e2, Boolean(null == n2 ? void 0 : n2.execute) ? Tt(Tt({}, e2), {}, { requests: e2.queries.map(function(n3) {
  ...
  return t2.map(function(t3) {
    var n2 = e2.filter(function(e3) {
      ...
      var t4 = e3.map(function(e4) {
        var t5;
        return ht(ht({}, e4), {}, { hits: null === (t5 = e4.hits) || void 0 === t5 ? void 0 : t5.map(function(t6) {
...
function Gt(e2) {
  var t2 = e2.event, n2 = e2.nextState, r2 = void 0 === n2 ? {} : n2, o2 = e2.props, c2 = e2.query, i2 = e2.refresh, a2 = e2.store, u2 = Wt(e2, Ft);
...
function mn(e2) {
  ...
  return { getEnvironmentProps: function(e3) {
    ...
    return sn({ action: "", noValidate: true, role: "search", onSubmit: function(c2) {
      var i2;
      c2.preventDefault(), t2.onSubmit(sn({ event: c2, refresh: n2, state: r2.getState() }, o2)), r2.dispatch("submit", null), null === (i2 = e3.inputElement) || void 0 === i2 || i2.blur();
    }, onReset: function(c2) {
      var i2;
      c2.preventDefault(), t2.onReset(sn({ event: c2, refresh: n2, state: r2.getState() }, o2)), r2.dispatch("reset", null), null === (i2 = e3.inputElement) || void 0 === i2 || i2.focus();
    } }, pn(e3, cn));
    ...
    var i2 = "ontouchstart" in t2.environment, a2 = e3 || {}, u2 = (a2.inputElement, a2.maxLength), l2 = void 0 === u2 ? 512 : u2, s2 = pn(a2, an), f2 = mt(r2.getState());
    return sn({ "aria-autocomplete": "both", "aria-activedescendant": r2.getState().isOpen && null !== r2.getState().activeItemId ? "".concat(t2.id, "-item-").concat(r2.getState().activeItemId) : void 0, "aria-controls": r2.getState().isOpen ? "".concat(t2.id, "-list") : void 0, "aria-labelledby": "".concat(t2.id, "-label"), value: r2.getState().completion || r2.getState().query, id: "".concat(t2.id, "-input"), autoComplete: "off", autoCorrect: "off", autoCapitalize: "off", enterKeyHint: null != f2 && f2.itemUrl ? "go" : "search", spellCheck: "false", autoFocus: t2.autoFocus, placeholder: t2.placeholder, maxLength: l2, type: "search", onChange: function(e4) {
      ...
      !function(e5) {
        ...
        if ("ArrowUp" === t3.key || "ArrowDown" === t3.key) {
          ...
          t3.preventDefault(), false === o3.getState().isOpen && (n3.openOnFocus || Boolean(o3.getState().query)) ? Gt(en({ event: t3, props: n3, query: o3.getState().query, refresh: r3, store: o3 }, c3)).then(function() {
          ...
          if (t3.metaKey || t3.ctrlKey)
            void 0 !== f3 && (p2.onSelect(en({ event: t3, item: l3, itemInputValue: s3, itemUrl: f3, refresh: r3, source: p2, state: o3.getState() }, c3)), n3.navigator.navigateNewTab({ itemUrl: f3, item: l3, state: o3.getState() }));
          else if (t3.shiftKey)
            void 0 !== f3 && (p2.onSelect(en({ event: t3, item: l3, itemInputValue: s3, itemUrl: f3, refresh: r3, source: p2, state: o3.getState() }, c3)), n3.navigator.navigateNewWindow({ itemUrl: f3, item: l3, state: o3.getState() }));
          else if (t3.altKey)
            ;
          else {
            if (void 0 !== f3)
...
function yn(e2) {
  var t2, n2, r2, o2, c2 = e2.plugins, i2 = e2.options, a2 = null === (t2 = ((null === (n2 = i2.__autocomplete_metadata) || void 0 === n2 ? void 0 : n2.userAgents) || [])[0]) || void 0 === t2 ? void 0 : t2.segment, u2 = a2 ? vn({}, a2, Object.keys((null === (r2 = i2.__autocomplete_metadata) || void 0 === r2 ? void 0 : r2.options) || {})) : {};
  return { plugins: c2.map(function(e3) {
    return { name: e3.name, options: Object.keys(e3.__autocomplete_pluginOptions || []) };
  }), options: hn({ "autocomplete-core": Object.keys(i2) }, u2), ua: nt.concat((null === (o2 = i2.__autocomplete_metadata) || void 0 === o2 ? void 0 : o2.userAgents) || []) };
}
function _n(e2) {
  var t2, n2 = e2.state;
  return false === n2.isOpen || null === n2.activeItemId ? null : (null === (t2 = mt(n2)) || void 0 === t2 ? void 0 : t2.itemInputValue) || null;
}
function bn(e2, t2) {
  var n2 = Object.keys(e2);
  if (Object.getOwnPropertySymbols) {
...
function Pn(e2) {
  var t2 = [], n2 = function(e3, t3) {
    ...
    return Pt(Pt({ debug: false, openOnFocus: false, placeholder: "", autoFocus: false, defaultActiveItemId: null, stallThreshold: 300, environment: r3, shouldPanelOpen: function(e4) {
      ...
      return e4.sources;
    } }, e3), {}, { id: null !== (n3 = e3.id) && void 0 !== n3 ? n3 : "autocomplete-".concat(Ze++), plugins: o3, initialState: Pt({ activeItemId: null, query: "", completion: null, collections: [], isOpen: false, status: "idle", context: {} }, e3.initialState), onStateChange: function(t4) {
      var n4;
  ...
  return n2.plugins.forEach(function(e3) {
    var n3;
    return null === (n3 = e3.subscribe) || void 0 === n3 ? void 0 : n3.call(e3, wn(wn({}, o2), {}, { refresh: i2, onSelect: function(e4) {
      t2.push({ onSelect: e4 });
    ...
    if (null === (t3 = r3.navigator) || void 0 === t3 ? void 0 : t3.userAgent.includes("Algolia Crawler")) {
...
function Jn(e2) {
  var t2 = e2.translations, n2 = void 0 === t2 ? {} : t2, r2 = Kn(e2, Vn), o2 = n2.noResultsText, c2 = void 0 === o2 ? "No results for" : o2, i2 = n2.suggestedQueryText, a2 = void 0 === i2 ? "Try searching for" : i2, u2 = n2.reportMissingResultsText, l2 = void 0 === u2 ? "Believe this query should return results?" : u2, s2 = n2.reportMissingResultsLinkText, f2 = void 0 === s2 ? "Let us know." : s2, p2 = r2.state.context.searchSuggestions;
...
function er(e2) {
  ...
  return g(void 0 === r2 ? "span" : r2, Yn(Yn({}, Zn(e2, $n)), {}, { dangerouslySetInnerHTML: { __html: Xn(t2, "_snippetResult.".concat(n2, ".value")) || Xn(t2, n2) } }));
}
function tr(e2, t2) {
  return function(e3) {
    if (Array.isArray(e3))
...
function or(e2) {
  return e2.collection && 0 !== e2.collection.items.length ? Ue.createElement("section", { className: "DocSearch-Hits" }, Ue.createElement("div", { className: "DocSearch-Hit-source" }, e2.title), Ue.createElement("ul", e2.getListProps(), e2.collection.items.map(function(t2, n2) {
...
function cr(e2) {
  ...
  return Ue.createElement("li", rr({ className: ["DocSearch-Hit", t2.__docsearch_parent && "DocSearch-Hit--Child", s2 && "DocSearch-Hit--deleting", m2 && "DocSearch-Hit--favoriting"].filter(Boolean).join(" "), onTransitionEnd: function() {
    ...
    i2(t2);
  } })), Ue.createElement(v2, { hit: t2 }, Ue.createElement("div", { className: "DocSearch-Hit-Container" }, r2({ item: t2, index: n2 }), t2.hierarchy[t2.type] && "lvl1" === t2.type && Ue.createElement("div", { className: "DocSearch-Hit-content-wrapper" }, Ue.createElement(er, { className: "DocSearch-Hit-title", hit: t2, attribute: "hierarchy.lvl1" }), t2.content && Ue.createElement(er, { className: "DocSearch-Hit-path", hit: t2, attribute: "content" })), t2.hierarchy[t2.type] && ("lvl2" === t2.type || "lvl3" === t2.type || "lvl4" === t2.type || "lvl5" === t2.type || "lvl6" === t2.type) && Ue.createElement("div", { className: "DocSearch-Hit-content-wrapper" }, Ue.createElement(er, { className: "DocSearch-Hit-title", hit: t2, attribute: "hierarchy.".concat(t2.type) }), Ue.createElement(er, { className: "DocSearch-Hit-path", hit: t2, attribute: "hierarchy.lvl1" })), "content" === t2.type && Ue.createElement("div", { className: "DocSearch-Hit-content-wrapper" }, Ue.createElement(er, { className: "DocSearch-Hit-title", hit: t2, attribute: "content" }), Ue.createElement(er, { className: "DocSearch-Hit-path", hit: t2, attribute: "hierarchy.lvl1" })), o2({ item: t2, runDeleteTransition: function(e3) {
...
function yr(e2) {
  var t2 = e2.translations, n2 = void 0 === t2 ? {} : t2, r2 = vr(e2, dr), o2 = n2.recentSearchesTitle, c2 = void 0 === o2 ? "Recent" : o2, i2 = n2.noRecentSearchesText, a2 = void 0 === i2 ? "No recent searches" : i2, u2 = n2.saveRecentSearchButtonTitle, l2 = void 0 === u2 ? "Save this search" : u2, s2 = n2.removeRecentSearchButtonTitle, f2 = void 0 === s2 ? "Remove this search from history" : s2, p2 = n2.favoriteSearchesTitle, m2 = void 0 === p2 ? "Favorite" : p2, d2 = n2.removeFavoriteSearchButtonTitle, h2 = void 0 === d2 ? "Remove this search from favorites" : d2;
  return "idle" === r2.state.status && false === r2.hasCollections ? r2.disableUserPersonalization ? null : Ue.createElement("div", { className: "DocSearch-StartScreen" }, Ue.createElement("p", { className: "DocSearch-Help" }, a2)) : false === r2.hasCollections ? null : Ue.createElement("div", { className: "DocSearch-Dropdown-Container" }, Ue.createElement(or, hr({}, r2, { title: c2, collection: r2.state.collections[0], renderIcon: function() {
...
var Or = Ue.memo(function(e2) {
  var t2 = e2.translations, n2 = void 0 === t2 ? {} : t2, r2 = gr(e2, _r);
  if ("error" === r2.state.status)
    return Ue.createElement(Bn, { translations: null == n2 ? void 0 : n2.errorScreen });
  var o2 = r2.state.collections.some(function(e3) {
    return e3.items.length > 0;
  });
  return r2.state.query ? false === o2 ? Ue.createElement(Jn, br({}, r2, { translations: null == n2 ? void 0 : n2.noResultsScreen })) : Ue.createElement(mr, r2) : Ue.createElement(yr, br({}, r2, { hasCollections: o2, translations: null == n2 ? void 0 : n2.startScreen }));
}, function(e2, t2) {
...
function jr(e2) {
  var t2 = e2.translations, n2 = void 0 === t2 ? {} : t2, r2 = wr(e2, Sr), o2 = n2.resetButtonTitle, c2 = void 0 === o2 ? "Clear the query" : o2, i2 = n2.resetButtonAriaLabel, a2 = void 0 === i2 ? "Clear the query" : i2, u2 = n2.cancelButtonText, l2 = void 0 === u2 ? "Cancel" : u2, s2 = n2.cancelButtonAriaLabel, f2 = void 0 === s2 ? "Cancel" : s2, p2 = r2.getFormProps({ inputElement: r2.inputRef.current }).onReset;
...
function Dr(e2) {
  var t2 = e2.key, n2 = e2.limit, r2 = void 0 === n2 ? 5 : n2, o2 = kr(t2), c2 = o2.getItem().slice(0, r2);
...
function Vr(e2) {
  var n2 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : Ur;
  return t(t({}, e2), {}, { status: n2, lastUpdate: Date.now() });
}
function zr(e2) {
  return "string" == typeof e2 ? { protocol: "https", url: e2, accept: Hr.Any } : { protocol: e2.protocol || "https", url: e2.url, accept: e2.accept || Hr.Any };
}
var Wr = "GET", Kr = "POST";
function Jr(e2, t2) {
...
function $r(e2, n2, r2, o2) {
  var c2 = [], i2 = function(e3, n3) {
    if (e3.method === Wr || void 0 === e3.data && void 0 === n3.data)
      return;
...
function Gr(e2) {
  return Object.keys(e2).map(function(t2) {
    return Lr("%s=%s", t2, (n2 = e2[t2], "[object Object]" === Object.prototype.toString.call(n2) || "[object Array]" === Object.prototype.toString.call(n2) ? JSON.stringify(e2[t2]) : e2[t2]));
    var n2;
  }).join("&");
}
function Zr(e2) {
...
var eo = function(e2) {
  ...
  }(void 0 !== e2.authMode ? e2.authMode : qr.WithinHeaders, n2, e2.apiKey), o2 = function(e3) {
...
function go(e2) {
  var t2 = e2.appId, n2 = e2.apiKey, r2 = e2.indexName, o2 = e2.placeholder, c2 = void 0 === o2 ? "Search docs" : o2, i2 = e2.searchParameters, a2 = e2.onClose, u2 = void 0 === a2 ? ur : a2, l2 = e2.transformItems, s2 = void 0 === l2 ? ar : l2, f2 = e2.hitComponent, p2 = void 0 === f2 ? Cn : f2, m2 = e2.resultsFooterComponent, d2 = void 0 === m2 ? function() {
    return null;
  } : m2, h2 = e2.navigator, v2 = e2.initialScrollY, y2 = void 0 === v2 ? 0 : v2, _2 = e2.transformSearchClient, b2 = void 0 === _2 ? ar : _2, g2 = e2.disableUserPersonalization, O2 = void 0 !== g2 && g2, S2 = e2.initialQuery, E2 = void 0 === S2 ? "" : S2, w2 = e2.translations, j2 = void 0 === w2 ? {} : w2, P2 = e2.getMissingResultsUrl, I2 = j2.footer, k2 = j2.searchBox, D2 = bo(j2, fo), C2 = yo(Ue.useState({ query: "", collections: [], completion: null, context: {}, isOpen: false, activeItemId: null, status: "idle" }), 2), A2 = C2[0], x2 = C2[1], N2 = Ue.useRef(null), R2 = Ue.useRef(null), T2 = Ue.useRef(null), L2 = Ue.useRef(null), q2 = Ue.useRef(null), M2 = Ue.useRef(10), H2 = Ue.useRef("undefined" != typeof window ? window.getSelection().toString().slice(0, 64) : "").current, U2 = Ue.useRef(E2 || H2).current, F2 = function(e3, t3, n3) {
    return Ue.useMemo(function() {
      var r3 = so(e3, t3);
      return r3.addAlgoliaAgent("docsearch", "3.0.0"), false === /docsearch.js \(.*\)/.test(r3.transporter.userAgent.value) && r3.addAlgoliaAgent("docsearch-react", "3.0.0"), n3(r3);
    }, [e3, t3, n3]);
  }(t2, n2, b2), B2 = Ue.useRef(Dr({ key: "__DOCSEARCH_FAVORITE_SEARCHES__".concat(r2), limit: 10 })).current, V2 = Ue.useRef(Dr({ key: "__DOCSEARCH_RECENT_SEARCHES__".concat(r2), limit: 0 === B2.getAll().length ? 7 : 4 })).current, z2 = Ue.useCallback(function(e3) {
    if (!O2) {
          ...
          return { sourceId: "hits".concat(t5), onSelect: function(e6) {
            ...
            return Object.values(ir(e5, function(e6) {
              ...
              return e6.map(function(t6) {
                return ho(ho({}, t6), {}, { __docsearch_parent: "lvl1" !== t6.type && e6.find(function(e7) {
...
function wo(e2) {
  var t2, n2, r2 = Ue.useRef(null), o2 = So(Ue.useState(false), 2), c2 = o2[0], i2 = o2[1], a2 = So(Ue.useState((null == e2 ? void 0 : e2.initialQuery) || void 0), 2), u2 = a2[0], l2 = a2[1], s2 = Ue.useCallback(function() {
    i2(true);
  ...
  return function(e3) {
    ...
    i2(true), l2(e3.key);
  }, [i2, l2]), searchButtonRef: r2 }), Ue.createElement(Ue.Fragment, null, Ue.createElement(Ke, { ref: r2, translations: null == e2 || null === (t2 = e2.translations) || void 0 === t2 ? void 0 : t2.button, onClick: s2 }), c2 && je(Ue.createElement(go, Oo({}, e2, { initialScrollY: window.scrollY, initialQuery: u2, translations: null == e2 || null === (n2 = e2.translations) || void 0 === n2 ? void 0 : n2.modal, onClose: f2 })), document.body));
}
function jo(e2) {
