...
```js
console.log("%c props from main framework", "color:#0f0;", props)
console.log('%c props from %c main %c framework','color:#f00;','font-size:20px;','color:blue;background:yellow;', props)
```
