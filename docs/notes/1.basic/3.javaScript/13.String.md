...
```js
const device = document.querySelector('#aaaa')
console.log(device)
svgNS = "http://www.w3.org/2000/svg"
const animateGraph = document.createElementNS(svgNS, "animate")
...
```html
<animate id="keyId113997366104687951" attributeType="auto" attributeName="visibility" from="visible" to="hidden" dur="1s" begin="0s" fill="freeze" repeatCount="indefinite"></animate>
```
