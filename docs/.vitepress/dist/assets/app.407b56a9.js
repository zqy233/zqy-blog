...
const _sfc_main$w = /* @__PURE__ */ defineComponent({
  setup(__props) {
    const { theme } = useData();
    const VPAlgoliaSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPAlgoliaSearchBox.01e0f753.js"), true ? [] : void 0));
    const loaded = ref(false);
    const metaKey = ref({
      textContent: ""
    });
...
const _withScopeId$1 = (n) => (pushScopeId("data-v-394353b2"), n = n(), popScopeId(), n);
...
var VPContentDocOutline = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-394353b2"]]);
