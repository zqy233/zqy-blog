...
var VPNavBarTitle = /* @__PURE__ */ _export_sfc(_sfc_main$x, [["__scopeId", "data-v-0871ccb2"]]);
...
const _sfc_main$w = /* @__PURE__ */ defineComponent({
  setup(__props) {
    const { theme } = useData();
    const VPAlgoliaSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPAlgoliaSearchBox.0bc7d500.js"), true ? [] : void 0));
    const loaded = ref(false);
    const metaKey = ref({
      textContent: ""
    });
