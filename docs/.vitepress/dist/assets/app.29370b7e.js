...
const _sfc_main$w = /* @__PURE__ */ defineComponent({
  setup(__props) {
    const { theme } = useData();
    const VPAlgoliaSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPAlgoliaSearchBox.4d5b7116.js"), true ? [] : void 0));
    const loaded = ref(false);
    const metaKey = ref({
      textContent: ""
    });
