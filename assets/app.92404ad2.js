...
const _sfc_main$w = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const VPAlgoliaSearchBox = defineAsyncComponent(
      () => __vitePreload(() => import("./chunks/VPAlgoliaSearchBox.36a9b7d1.js"), true ? [] : void 0)
    );
    const loaded = ref(false);
    const metaKey = ref({
      textContent: ""
