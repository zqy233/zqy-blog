import{_ as s,o as n,c as a,a as l}from"./app.bfa9bd4b.js";const d=JSON.parse('{"title":"起步","description":"","frontmatter":{},"headers":[{"level":2,"title":"安装","slug":"安装","link":"#安装","children":[]},{"level":2,"title":"初始化编辑器","slug":"初始化编辑器","link":"#初始化编辑器","children":[]},{"level":2,"title":"在页面上加载Monaco","slug":"在页面上加载monaco","link":"#在页面上加载monaco","children":[]},{"level":2,"title":"载入自己的Type Definition","slug":"载入自己的type-definition","link":"#载入自己的type-definition","children":[]},{"level":2,"title":"注册主题","slug":"注册主题","link":"#注册主题","children":[]},{"level":2,"title":"更新编辑器配置","slug":"更新编辑器配置","link":"#更新编辑器配置","children":[]}],"relativePath":"4.库/Monaco-Editor/Monaco-Editor.md","lastUpdated":1720835436698}'),p={name:"4.库/Monaco-Editor/Monaco-Editor.md"},e=l(`<h1 id="起步" tabindex="-1">起步 <a class="header-anchor" href="#起步" aria-hidden="true">#</a></h1><blockquote><p><a href="https://link.juejin.cn/?target=https%3A%2F%2Fmicrosoft.github.io%2Fmonaco-editor%2F" target="_blank" rel="noreferrer">Monaco Editor</a> 是 <a href="https://link.juejin.cn/?target=https%3A%2F%2Fgithub.com%2FMicrosoft%2Fvscode" target="_blank" rel="noreferrer">VS Code</a> 底层的代码编辑器，开源协议是MIT，支持Edge、 Chrome、Firefox、Safari和Opera浏览器，但是不支持移动端浏览器或移动端框架</p></blockquote><h2 id="安装" tabindex="-1">安装 <a class="header-anchor" href="#安装" aria-hidden="true">#</a></h2><div class="language-sh line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki one-dark-pro vp-code-dark" tabindex="0"><code><span class="line"><span style="color:#61AFEF;">npm</span><span style="color:#ABB2BF;"> </span><span style="color:#98C379;">install</span><span style="color:#ABB2BF;"> </span><span style="color:#98C379;">monaco-editor</span><span style="color:#ABB2BF;"> </span></span>
...
<span class="line"></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br></div></div>`,19),o=[e];function r(t,c,i,b,y,B){return n(),a("div",null,o)}const m=s(p,[["render",r]]);export{d as __pageData,m as default};
